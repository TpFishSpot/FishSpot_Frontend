  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      {especies.map((especie) => (
        <div
          key={especie.id}
          className="bg-white/20 backdrop-blur-sm border border-white/30 rounded-xl p-4 hover:bg-white/30 transition-all duration-300 hover:scale-105 hover:shadow-lg"
        >
          <div className="flex items-start gap-4">
            <div className="flex-shrink-0">
              <img
                src={especie.imagen ? `http://localhost:3000/${especie.imagen}` : "/colorful-fish-shoal.png"}
